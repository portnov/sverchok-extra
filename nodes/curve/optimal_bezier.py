...
def register():
    bpy.utils.register_class(SvExOptimalBezierSplineNode)


def unregister():
    bpy.utils.unregister_class(SvExOptimalBezierSplineNode)
