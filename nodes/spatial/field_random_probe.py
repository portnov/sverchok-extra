...
class SvExFieldRandomProbeNode(bpy.types.Node, SverchCustomTreeNode):
    """
    Triggers: Scalar Field Random Probe
    Tooltip: Generate random points according to scalar field
    """
    bl_idname = 'SvExFieldRandomProbeNode'
...
def register():
    bpy.utils.register_class(SvExFieldRandomProbeNode)

def unregister():
    bpy.utils.unregister_class(SvExFieldRandomProbeNode)
